...
/*
        ...
        this.add(new Franquicia("Bjo Cero"));
        this.add(new Franquicia("El Jamoncito"));
        this.add(new Franquicia("Espacio Lector Nobel"));
        this.add(new Franquicia("Helados El Arte"));

        this.add(new Franquicia("Ibero Trade Place"));
        this.add(new Franquicia("Krack"));
        this.add(new Franquicia("Mini Call"));
